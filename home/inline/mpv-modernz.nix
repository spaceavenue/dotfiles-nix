{
  ...
  "zoom_out_min" = "-1";
  "osc_color" = "#180004";
  "window_title_color" = "#ffd1db";
  "window_controls_color" = "#f38ba8";
  "windowcontrols_close_hover" = "#F45C5B";
  "windowcontrols_max_hover" = "#F8BC3A";
  "windowcontrols_min_hover" = "#43CB44";
  "title_color" = "#ffd1db";
  "cache_info_color" = "#ffd1db";
  "seekbar_cache_color" = "#5a4549";
  "seekbarfg_color" = "#f38ba8";
  "seekbarbg_color" = "#5a4549";
  "seek_handle_color" = "#f38ba8";
  "seek_handle_border_color" = "#180004";
  "volumebar_match_seek_color" = "yes";
  "time_color" = "#ffd1db";
  "chapter_title_color" = "#ffd1db";
  "side_buttons_color" = "#f38ba8";
  "middle_buttons_color" = "#f38ba8";
  "playpause_color" = "#f38ba8";
  "held_element_color" = "#ffd1db";
  "hover_effect_color" = "#ffd1db";
  "thumbnail_box_color" = "#180004";
  "thumbnail_box_outline" = "#f38ba8";
  "nibble_color" = "#f38ba8";
  "nibble_current_color" = "#ffd1db";
  "ab_loop_color" = "#ffd1db";
