...
in
{
  ...
  "zoom_in_max" = "4";
  "zoom_out_min" = "-1";
  "osc_color" = palette.shadow;
  "window_title_color" = palette.text;
  "window_controls_color" = palette.red;
  "windowcontrols_close_hover" = "#F45C5B";
  "windowcontrols_max_hover" = "#F8BC3A";
  "windowcontrols_min_hover" = "#43CB44";
  "title_color" = palette.text;
  "cache_info_color" = palette.text;
  "seekbar_cache_color" = palette.dim;
  "seekbarfg_color" = palette.red;
  "seekbarbg_color" = palette.dim;
  "seek_handle_color" = palette.red;
  "seek_handle_border_color" = palette.shadow;
  "volumebar_match_seek_color" = "yes";
  "time_color" = palette.text;
  "chapter_title_color" = palette.text;
  "side_buttons_color" = palette.red;
  "middle_buttons_color" = palette.red;
  "playpause_color" = palette.red;
  "held_element_color" = palette.text;
  "hover_effect_color" = palette.text;
  "thumbnail_box_color" = palette.shadow;
  "thumbnail_box_outline" = palette.red;
  "nibble_color" = palette.red;
  "nibble_current_color" = palette.text;
  "ab_loop_color" = palette.text;
